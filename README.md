...
Go [**`here`**](https://github.com/buntyxxx/Cervical_Cancer_Predection_with_ML/) if you aren't here already and click ➞ **`✰ Star`** and **`ⵖ Fork`** button in the top right corner. You'll be asked to create a GitHub account if you don't already have one.
